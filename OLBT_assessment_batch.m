...
for n = 1:length(filenames)
    try
        ...
        for i = 1:(time-1)
            try
                if (abs(landing_foot_height(i)) > 10 && abs(landing_foot_height(i+5000)) > 10) || (abs(main_moving_leg(i5000)) > 30 && abs(main_moving_leg(i+5000)) > 30) || (abs(swinging_FP(i)) > 100 && abs(swinging_FP(i+5000)) > 100) %%% stance (instead of supporting) and swing 
        ...
        saved_path_name = "C:\Users\a1003\OneDrive\桌面\Thesis\data\OLBT\sub1to31\" + subjfile(1:end-4) + ".csv";
